...
public class ScheduleService {
	...
	public Page<ReceptionDTO> getUserReceptions(Pageable pageable, LocalDate date, Long id) {
		Page<Reception> page = scheduleRepository.getReceptionsByDateAndUser(pageable, date, id);
		return new PageImpl<>(convertToDTO(page.getContent()), pageable, page.getTotalElements());
	}
}
